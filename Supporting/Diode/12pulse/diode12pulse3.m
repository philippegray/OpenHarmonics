...
%April 26, 2012
%********************************************************
cd('C:\Users\SEPIGRA\Dropbox\Masters\Matlab\Converter Models\Diode12Pulse\');
clear all;
...
% maxPos = 3*lenHarm+1;
% derivRotation_back = zeros(maxPos,maxPos);
% 
% count = 1;
% for j  = -h:1:h
%     derivRotation_back(count:count+1,count:count+1) = ...
