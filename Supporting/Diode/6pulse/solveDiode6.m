function [Ia Ib Ic fundCurrents phaseAng gamma mu Pload Rdc] =...
    solveDiode6(Valphabeta,L,R,Rdc_in,Ldc,h,Vdc_in,P_in,mu_in,gamma_in,phaseAng_in)
...
if mu_in == -1
    ...
    mu_prev = mu_i*ones(6,1);
    gamma_prev = pi/3*ones(6,1);
...
for i = 1:2:h
    ...
    while(convergance == 0)      
        [Ia Ib Ic fundCurrents phaseAng gamma mu Pload error] =...
            solveDiode6Model(V,L,R,Rdc,Ldc,i,Vdc,P,mu_prev,gamma_prev,phaseAng_prev);
