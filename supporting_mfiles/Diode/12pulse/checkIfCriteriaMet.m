...
for i = 1:3:length(MonitorList)
    ...
    Va = csvread([OpenDSSFile,'_Mon_',char(MonitorList(i)),'_1.csv'],1,2,...
        [1,2,numHarmonics,3]);
    Vb = csvread([OpenDSSFile,'_Mon_',char(MonitorList(i+1)),'_1.csv'],1,2,...
        [1,2,numHarmonics,3]);
    Vc = csvread([OpenDSSFile,'_Mon_',char(MonitorList(i+2)),'_1.csv'],1,2,...
        [1,2,numHarmonics,3]);
